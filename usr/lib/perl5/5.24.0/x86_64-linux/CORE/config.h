...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Tue Jan 17 17:44:27 UTC 2017
 * Configured by     : root
 * Target system     : linux zeus 3.16.0-4-amd64 #1 smp debian 3.16.36-1+deb8u2 (2016-10-19) x86_64 gnulinux 
 */
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PERL_VENDORARCH "/usr/lib/perl5/vendor_perl/5.24.0/x86_64-linux"		/**/
#define PERL_VENDORARCH_EXP "/usr/lib/perl5/vendor_perl/5.24.0/x86_64-linux"		/**/
 ...
 *	be tacked onto this variable to generate a list of directories to search.
 */
#define PERL_VENDORLIB_EXP "/usr/lib/perl5/vendor_perl/5.24.0"		/**/
